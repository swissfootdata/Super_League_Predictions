...
tabelle$team <- gsub("Lausanne-Sport","FC Lausanne-Sport",tabelle$team)
...
#Tabellendaten laden
url <- paste0("https://www.transfermarkt.ch/super-league/spieltagtabelle/wettbewerb/C1?saison_id=2022&spieltag=",as.numeric(round)-1)
webpage <- read_html(url)
